...
import { getStorageAuthToken, setStorageAuthToken } from '@storage/storageAuthToken';
            ...
            if (requestError.response.data?.message === 'token.expired' ||
                ...
                return new Promise(async (resolve, reject) => {
                    try {
                        ...
                        await setStorageAuthToken({ token: data.token, refresh_token: data.refresh_token });
